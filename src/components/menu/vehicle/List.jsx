...
export default function List(params) {
  ...
  const filteredVehicles = vehicles.filter((vehicle) =>
    ["user_name", "user_email"].some((key) =>
      String(vehicle[key] || "").toLowerCase().includes(searchQuery.toLowerCase())
    )
  );
      ...
      <div className='container'>
        ...
        <section className='list'>
          <div className='vehicleListHeader'>
            ...
            <div>
              <p>Car Name</p>
              <svg onClick={()=>sortVehicles('user_name')} xmlns="http://www.w3.org/2000/svg" width="16" viewBox="0 0 21 24" fill="currentColor">
            ...
            <div>
              <p>Group</p>
              <svg onClick={()=>sortVehicles('user_email')} xmlns="http://www.w3.org/2000/svg" width="16" viewBox="0 0 21 24" fill="currentColor">
                <path d="M10.4587 21L14.3809 14.5H6.5365L10.4587 21ZM10.4587 3L14.3809 9.5H6.5365L10.4587 3Z" fill="white" stroke="white" stroke-width="2" stroke-linejoin="round"/>
              </svg>
            </div>
            <div>
