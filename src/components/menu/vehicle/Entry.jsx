        ...
        <form onSubmit={handleSubmit}>
          <div className={`formGroup modelTwoColumn`}>
            <div>
              ...
              <div className="inputContainer">
                ...
                <select name="" id="" onChange={handleChange} value={formData.groupingType} className="input">
                    ...
                    <option value="2">Scrapped</option>
                  </select>
              </div>
            ...
            <div>
              <div>
                <p>Vehicle Photo</p>
                <div className="imageUploadContainer"><ImageUpload/></div>
              </div>
              ...
              <div className="inputContainer">
                <label htmlFor="name" className="inputLabel">
                  ...
                  <div className="instruction">
                    <small>Please enter note</small>
                  </div>
                </label>
                <textarea name="" id="" placeholder="Please enter note" onChange={handleChange} className="input" value={formData.note}></textarea>
              </div>
              </div>
            </div>
          </div>
