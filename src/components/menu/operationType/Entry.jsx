...
export default function Entry({
  ...
  const handleSubmit = (e) => {
    ...
    const url = id
      ? `http://localhost:8383/usertypes/update`
      : "http://localhost:8383/usertypes/create";
              ...
              <div className="flexRow colorFlexRow">
                ...
                <div className="colorPickerWrapper">
                  <input
                    type="color"
                    name="color"
                    value={colorToHex(formData.color)} // Convert color name to hex for the input value
                    onChange={handleChange}
                    className="colorInput"
                    aria-label="Choose color"
                  />
                  <div
                    className="colorPreview"
                    style={{ backgroundColor: formData.color }} // Display color name or hex value
                  />
                </div>
